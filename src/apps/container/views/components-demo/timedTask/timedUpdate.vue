<template>
  <div class="update-component-container">
            ...
            <div class="margin-top" style="padding: 0 20px">
              ...
              <el-form ref="infoRuleForm" :model="infoRuleForm" label-width="150px" label-suffix=":">
                ...
                <el-form-item label="显示名称">
                  <el-input v-model="infoRuleForm.labelName" />
                </el-form-item>
              </el-form>
              ...
              <el-form ref="timingForm" :model="infoRuleForm" label-width="150px" label-suffix=":">
                ...
                <el-form-item label="触发规则">
                  ...
                  <span>下次触发时间2022-12-26 02:30:00 详细输入规则请前往<a href="#">参考文档</a>以协调世界时（UTC）表示</span>
                </el-form-item>
                ...
                <div class="flex-center" style="justify-content: start">
                  <el-form-item label="保留任务历史">
                    <el-input v-model="infoRuleForm.cpu">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td colspan="5">
                            <div
                              class="cursor-pointer text-center hover-div"
                              @click="handleAdd('containerGroupLabels')"
                            >
                              <i class="el-icon-circle-plus-outline" />
                              添加
                            </div>
    ...
    <div class="fixed-div">
      <el-button type="primary" class="margin-left10" @click="submitCreate">更新</el-button>
