  ...
  data() {
    ...
    return {
      ...
      initResourceList: [
        ...
        { id: 17, name: 'ClusterServiceVersion', version: ['operators.coreos.com'] },
        ...
        { id: 36, name: 'GitlabOfficial', version: ['operator.devops.alauda.io'] },
        ...
        { id: 57, name: 'OperatorCondition', version: ['operators.coreos.com'] },
        { id: 58, name: 'OperatorGroup', version: ['operators.coreos.com'] },
        { id: 59, name: 'Order', version: ['acme.cert-manager.io'] },
        { id: 60, name: 'PackageManifest', version: ['packages.operators.coreos.com'] },
        ...
        { id: 72, name: 'ReferencePolicy', version: ['gateway.networking.k8s.io'] },
