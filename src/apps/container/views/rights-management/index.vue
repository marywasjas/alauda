        ...
        <el-col :span="24">
          <el-form ref="ruleForm" :model="ruleForm" label-width="100px">
            <el-row>
              <el-col :span="12">
                <el-form-item label="申请账号" prop="account">
                  <el-input v-model="ruleForm.account" style="width: 450px" placeholder="请输入..." />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="审批状态" prop="approvalStatus">
                  <el-select v-model="ruleForm.approvalStatus" style="width: 450px" placeholder="请选择...">
                    <el-option
            ...
            <el-form-item label="生效状态" prop="effectStatus">
              <el-select v-model="ruleForm.effectStatus" style="width: 450px" placeholder="请选择...">
