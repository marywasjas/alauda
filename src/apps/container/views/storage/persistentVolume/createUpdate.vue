      ...
      <BaseCard>
        <header>
          <div class="card-title right-header">
            <span v-if="type==='add'">创建持久卷声明</span>
          ...
          >
            ...
            <el-form-item label="创建方式" prop="createType">
              <el-radio-group v-model="ruleForm.createType">
                <el-radio label="dynamic">动态创建</el-radio>
                <el-radio label="static">静态匹配</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item v-if="ruleForm.createType==='dynamic'" label="存储类" prop="storageClass">
              <el-select v-model="ruleForm.storageClass" placeholder="请选择存储类">
                <el-option
            ...
            <el-form-item label="访问模式" prop="accessMode">
              <el-radio-group v-model="ruleForm.accessMode">
                <el-radio label="rox">多节点只读（ROX）</el-radio>
                <el-radio label="rwo">单节点读写（RWO）</el-radio>
                <el-radio label="rwx">多节点读写（RWX）</el-radio>
              </el-radio-group>
            ...
            <el-form-item label="容量" prop="capacity">
              <el-input v-model="ruleForm.capacity" placeholder="请输入内容" class="input-with-select">
                <el-button slot="append">Gi</el-button>
              </el-input>
            </el-form-item>
            <el-form-item label="卷模式" prop="volumeMode">
              <el-radio-group v-model="ruleForm.volumeMode">
                <el-radio label="file">文件系统</el-radio>
                <el-radio label="device">块设备</el-radio>
              </el-radio-group>
              <el-tooltip class="item" effect="dark" placement="top">
                <div slot="content">
            ...
            <foldable-block btn-tex="高级">
              ...
              <el-form-item label="注解" prop="annotations" style="margin-bottom: 0">
                <table border="0" style="width: 100%">
                  <thead>
                    <tr class="headerStyle">
                      <th>
              ...
              <el-form-item v-if="ruleForm.createType==='static'" label="选择器" prop="selectors" style="margin-bottom: 0">
                <table border="0" style="width: 100%">
                  <thead>
                    <tr class="headerStyle">
                      <th>
